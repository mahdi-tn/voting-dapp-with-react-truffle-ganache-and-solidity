...
class AddCandidate extends Component {
  ...
  captureFile(event) {
    ...
    reader.onloadend = () => {
      ...
      const blob = new Blob([buffer], { type: "image/png" }); // Specify the image type if known
      const imageUrl = URL.createObjectURL(blob);
      this.setState({ imageUrl: imageUrl }); // Save the imageUrl in state
    };
  }
                  ...
                  <div className="row">
                    <div className="col-md-4">
                      ...
                      >
                        ...
                        <div style={{ height: "250px", width: "200px", border: "1px dashed black", }}>
                          {this.state.imageUrl && <img src={this.state.imageUrl} alt="Uploaded profile" style={{ width: "200px", height: "250px", position: "absolute" }} />}
                        </div>
                        <button className="btn btn--blue" //onClick={this.uploadImage}
                        >Upload Photo</button>
                      </div>
                    </div>
